...
if (isset($_POST['supprimer_import']) && isset($_POST['id_import'])) {
    $stmt = $pdo->prepare("DELETE  FROM `releve` where id=:id_import");
    $stmt->execute(array("id_import" => $_POST['id_import']));
}
